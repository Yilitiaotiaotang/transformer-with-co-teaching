...
def load_data(root):
    if root.find("npy") != -1:
        ...
        data = torch.load("data/train_data_with_noise_symmetric_0.50.pt") # TODO: 修改训练数据集
...
def c_main():
    ...
    for epoch in range(n_epochs):
        ...
        if best < acc:
            ...
            torch.save(model, '/home/tbb/THAT/output/{}_noise_symmetric_0.50_with_co_20220619.pkl'.format(args.model)) # TODO: save path
        print("\nBest is", best)
